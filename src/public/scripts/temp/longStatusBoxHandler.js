...
export async function longStatusBoxHandler(ficha) {
    ...
    function fillPages() {
        ...
        const bgSize = (document.querySelector(".bgFicha").clientHeight - document.querySelector(".longStatusBox .titleBox").clientHeight) - 70;
        const base = 520
        const step = document.querySelector(".longStatusBox .atbs .atbBox atb").clientHeight;
